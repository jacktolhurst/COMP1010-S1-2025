...
\begin{center}
    \begin{tikzpicture}[scale=0.5, every node/.style={font=\small}]
        ...
        \draw[redNode, thick] (5,3) circle (0.6) node {\small SE};
        \draw[redNode, thick] (5,5) circle (0.6) node {\small DB};  
        \draw[redNode, thick] (3,5) circle (0.6) node {\small UA}; 
        \draw[yellowNode, thick] (3,3) circle (0.6) node {\small IT};
        \draw[greenNode, thick] (3,1) circle (0.6) node {\small SF};
