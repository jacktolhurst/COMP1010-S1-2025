...
\headerbox{Critical Infrastructure}{name=introduction,column=1,row=0,bottomaligned=objectives}{
...
\headerbox{Healthcare}{name=results,column=2,span=2,row=0}{
...
\headerbox{References}{name=references,column=0,span=2,row=0.75,height=0.25}{
...
\headerbox{Conclusion and Ethics}{name=conclusion,column=2,span=2,row=0,below=results,above=bottom}{
...
\headerbox{Finance}{name=method,column=0,below=objectives,above=references}{
...
\headerbox{Defence}{name=results2,column=1,below=objectives,above=references}{ % This block's bottom aligns with the bottom of the conclusion block
